...
--
-- Name: index_contracts_on_position; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_contracts_on_position ON contracts USING btree ("position");


--
-- Name: index_contracts_on_year; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_contracts_on_year ON contracts USING btree (year);


--
-- Name: index_divisions_on_league_id_and_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_divisions_on_league_id_and_name ON divisions USING btree (league_id, name);
...
--
-- Name: index_teams_on_division_id_and_name_and_city; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_teams_on_division_id_and_name_and_city ON teams USING btree (division_id, name, city);
